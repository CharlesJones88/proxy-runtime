export * from "@charlesjones88/proxy-runtime/assembly/proxy"; // this exports the required functions for the proxy to interact with us.
...
import {
  ...
  get_buffer_bytes,
  BufferTypeValues,
} from "@charlesjones88/proxy-runtime/assembly";
  ...
  onRequestHeaders(a: u32, end_of_stream: bool): FilterHeadersStatusValues {
    ...
    const result = this.root_context.httpCall(
      ...
      (
        ...
        log(LogLevelValues.debug, "auth body result: " + buf.result.toString());
