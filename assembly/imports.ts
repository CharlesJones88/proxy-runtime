...
export declare function proxy_get_status(
  status_code_ptr: ptr<u32>,
  message_ptr: ptr<ptr<char>>,
  message_size: ptr<usize>,
): u32;
...
export declare function proxy_get_log_level(
  status_code_ptr: ptr<LogLevel>,
): WasmResult;
...
export declare function proxy_get_property(
  path_ptr: ptr<char>,
  path_size: size_t,
  value_ptr_ptr: ptr<ptr<char>>,
  value_size_ptr: ptr<usize>,
): WasmResult;
...
export declare function proxy_continue_stream(
...
export declare function proxy_send_local_response(
  response_code: u32,
  response_code_details_ptr: ptr<char>,
  response_code_details_size: size_t,
  body_ptr: ptr<char>,
  body_size: size_t,
  additional_response_header_pairs_ptr: ptr<char>,
  additional_response_header_pairs_size: size_t,
  grpc_status: u32,
): WasmResult;
...
export declare function proxy_get_shared_data(
  key_ptr: ptr<char>,
  key_size: size_t,
  value_ptr: ptr<ptr<char>>,
  value_size: ptr<usize>,
  cas: ptr<u32>,
): WasmResult;
...
export declare function proxy_register_shared_queue(
  queue_name_ptr: ptr<char>,
  queue_name_size: size_t,
  token: ptr<u32>,
): WasmResult;
...
export declare function proxy_http_call(
  uri_ptr: ptr<char>,
  uri_size: size_t,
  header_pairs_ptr: ptr<void>,
  header_pairs_size: size_t,
  body_ptr: ptr<char>,
  body_size: size_t,
  trailer_pairs_ptr: ptr<void>,
  trailer_pairs_size: size_t,
...
export declare function proxy_grpc_call(
  service_ptr: ptr<char>,
  service_size: size_t,
  service_name_ptr: ptr<char>,
  service_name_size: size_t,
  method_name_ptr: ptr<char>,
  method_name_size: size_t,
  request_ptr: ptr<char>,
  request_size: size_t,
  timeout_milliseconds: u32,
  token_ptr: ptr<u32>,
): WasmResult;
...
export declare function proxy_call_foreign_function(
  function_name: ptr<char>,
  name_size: size_t,
  arguments: ptr<char>,
  arguments_size: size_t,
  results: ptr<ptr<char>>,
  results_size: ptr<size_t>,
): WasmResult;
