...
Add `"@charlesjones88/proxy-runtime": "file:/home/yuval/Projects/solo/proxy-assemblyscript"` to your dependencies.
run `pnpm install`

# using NPM

Just include the `@charlesjones88/proxy-runtime` package.
...
```ts
export * from "@charlesjones88/proxy-runtime/proxy"; // this exports the required functions for the proxy to interact with us.
import {
  RootContext,
  Context,
  registerRootContext,
  ...
  stream_context,
} from "@charlesjones88/proxy-runtime";
...
Configure WasmPlugin with your filter:
